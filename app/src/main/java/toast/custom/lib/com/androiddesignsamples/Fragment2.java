...
public class Fragment2 extends Fragment {
    ...
    private void initialiseViews(View view) {
        rv1 = view.findViewById(R.id.rvFeed);
        ...
        rv4 = view.findViewById(R.id.rvOpp);
